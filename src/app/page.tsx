...
const FAQ_DATA = [
  { question: '馬券の点数計算はどのように行いますか？', answer: '点数は、馬券種（順不同／着順あり、2頭／3頭）と買い方（通常・ながし・BOX・フォーメーション）に応じて算出します。順不同の馬券は「組み合わせ」の考え方、着順ありの馬券は「順序（並び）」の考え方を用います。フォーメーションは、同じ馬が複数の着順に重複しないように重複分を除外した点数になります。' },
