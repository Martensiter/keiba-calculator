    ...
    <article className="max-w-3xl mx-auto">
      ...
      <div className="bg-white dark:bg-(--color-surface-card) rounded-xl shadow-sm border border-(--color-border) p-6 space-y-6 text-(--color-text-secondary) leading-relaxed">
        ...
        <section>
          ...
          <p>
            当サイトでは、アクセス解析（Google Analytics 等）および広告配信（Google 広告、Meta 広告 等）のサービスを利用する場合があります。これらのサービスは、Cookie やその他の技術を使用して、アクセス数、ページビュー、利用環境（デバイス、ブラウザ）などの情報を収集することがあります。収集されるデータの詳細は、各サービスのプライバシーポリシーをご確認ください。
          </p>
        </section>
