...
const steps = [
  {
    ...
    content: [
      ...
      'JRA（日本中央競馬会）が主催する中央競馬は、主に土日にレースが開催されます（祝日開催など例外もあります）。',
  ...
  },
  {
    ...
    title: '馬券の種類を理解しよう',
    content: [
      '主な馬券は8種類あり、難易度と配当のバランスが異なります。加えて、単勝＋複勝をセットで買う「応援馬券」や、指定5レースの1着を当てる「WIN5」などもあります。',
  ...
  },
  {
    ...
    tips: [
      ...
      { title: '回収率を確認する', text: '計算ツールで回収率を確認し、「買いすぎていないか」「想定と比べて投資額が膨らんでいないか」をチェックしましょう。回収率は払戻金額 ÷ 投資額 × 100 で、100%を上回ればプラス、下回ればマイナスの目安です。' },
