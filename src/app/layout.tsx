...
export const metadata: Metadata = {
  ...
  title: {
    default: '競馬オッズ計算ツール | 買い目計算・馬券シミュレーション・回収率を無料で',
    template: '%s | 競馬オッズ計算ツール',
  },
  description: '競馬の買い目計算・オッズシミュレーションができる無料サイト。馬券点数・回収率をリアルタイム計算。馬連・馬単・ワイド・3連複・3連単に対応。JRAオッズ転記・即PAT取り込みで簡単にオッズ計算。BOX・ながし・フォーメーションの点数も自動計算。',
  keywords: ['競馬', 'オッズ計算', '買い目計算', '馬券シミュレーション', 'オッズシミュレーション', '馬券計算機', '馬券計算ツール', '3連単計算', '馬単オッズ計算', 'ワイドオッズ計算', 'JRAオッズ計算', '即PAT', '回収率計算', '馬連', 'ワイド', 'BOX計算', '競馬初心者', '馬券の買い方', 'フォーメーション計算'],
  openGraph: {
    title: '競馬オッズ計算ツール | 買い目計算・馬券シミュレーション・回収率を無料で',
    description: '競馬の買い目計算・オッズシミュレーションができる無料サイト。JRAオッズ転記・即PAT取り込み対応。馬連・馬単・ワイド・3連複・3連単の点数・回収率を自動計算。',
    type: 'website',
    locale: 'ja_JP',
    siteName: '競馬オッズ計算ツール',
  },
  twitter: {
    ...
    title: '競馬オッズ計算ツール | 買い目計算・馬券シミュレーション',
    description: '競馬の買い目計算・オッズシミュレーションができる無料サイト。JRAオッズ転記・即PAT取り込み対応。',
  },
  robots: { index: true, follow: true },
  alternates: { canonical: '/' },
  verification: {
    google: 'o9RKdBkqj5Iy7cKGzMZPLviaDTwHl0EQvbRvxBShpu4',
  },
};
